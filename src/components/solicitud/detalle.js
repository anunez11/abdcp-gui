...
import DetalleSolicitudPortabilidad from "./detalleSolicitud";
            ...
            <Layout>
              ...
              <Content style={{ margin: '0 16px' }}>
                ...
                <div style={{margin: '16px 0' , padding: 24, background: '#fff', minHeight: 360 }}>
                     <Row gutter={16}>
                        <Col span={8}> <DetalleSolicitudPortabilidad registro={this.props.registro} /></Col>
...
export default  connect(    mapStateToProps  )(DetalleSolicitud);
