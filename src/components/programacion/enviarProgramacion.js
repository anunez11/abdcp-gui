...
import {setListaProgramacionEnviado} from "../../action/ActionProgramacion";
      ...
      // e.preventDefault();
        this.props.form.validateFields((err, values) => {
          if (!err) {
                    ...
                    store.dispatch(setListaProgramacionEnviado(registro));
                    this.setState({ loading: true });
                    setTimeout(() => {
                      this.setState({ loading: false, visible: false });
                    }, 3000);
      ...
      render(){
        ...
        const { getFieldDecorator } = this.props.form
           return (
            ...
            <Modal width={450}
              visible={visible}
              title="Enviar Mensaje Programacion Portabilidad"
